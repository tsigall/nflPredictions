...
modelData <- games[,c(2, 4, 8, 10, 14, 45, 29, 22, 23)]
...
predictions<-predict(object=model, modelData[,c(7:27)])
results<-data.frame(predictions, modelData[,5], abs(predictions - modelData[,5]), modelData[,7])
